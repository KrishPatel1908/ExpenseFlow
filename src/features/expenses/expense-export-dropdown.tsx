...
import { exportExpensesExcel, shareExpensesExcelWhatsApp } from "@/lib/excel-export";

interface ExpenseExportDropdownProps {
  expenses: Expense[];
...
export function ExpenseExportDropdown({
  expenses,
  filteredExpenses,
  startDate,
  endDate,
              ...
              {exportTab === "pdf" ? (
                <>
                  <button
                    ...
                    disabled={isFilterApplied ? filteredExpenses.length === 0 : expenses.length === 0}
